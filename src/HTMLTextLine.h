...
private:
     ...
     */
    std::string dump_chars(std::ostream & out, std::ostream & feat, int & word_num, int begin, int len, bool & first);
    char dump_char(std::ostream & out,std::ostream & feat,   int & wordNum, int pos);
